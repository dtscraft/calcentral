Feature: display list view of the all events for the week.

	 As a student
	 so that I can plan out my weekly schedule
	 I want to be able to see a list view of events for the week
